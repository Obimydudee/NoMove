...
namespace NoMove
{
    internal class UI
    {
        ...
        public static void HRR(Page element) //hacks the registry root section
        {
        ...
        public static void setUi() 
        {
            ...
            //BetterBetterCharacterController bbcc = new BetterBetterCharacterController();
            nomovetoggle.OnValueUpdated += newbool =>
            {
                //Why does this have to be more annoying then it used to be??
                //it now makes me wanna kms :D
                if (newbool)
                {
